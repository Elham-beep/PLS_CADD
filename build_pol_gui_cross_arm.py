...
Author:Elham 10-Jul-2025
in this version we parametrized the cross arms and it worked on 2 different masts 
"""
...
# ─────────────────────────── settings ──────────────────────────────────────
TEMPLATE_PATH = pathlib.Path("Prueba n46 original.pol")
...
import re
_TOKEN_RE = re.compile(r"\b(firstA|secondA|thirdA|beamNo)\b")
# whole-word match of the   first   second   third  tokens
_PLACE_RE = re.compile(r"\b(firstA|secondA|thirdA|beamNo)\b")
