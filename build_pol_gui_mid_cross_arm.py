...
# ─────────────────────────── settings ──────────────────────────────────────
TEMPLATE_PATH = pathlib.Path("Prueba n46 original_midarm.pol")
...
import re
_TOKEN_RE = re.compile(r"\b(firstA|secondA|thirdA|midA|midB|beamNo)\b")
# whole-word match of the   first   second   third  tokens
_PLACE_RE = re.compile(r"\b(firstA|secondA|thirdA|midA|midB|beamNo)\b")
